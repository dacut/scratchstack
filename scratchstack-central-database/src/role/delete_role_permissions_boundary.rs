...
use {
    ...
    scratchstack_shapes_iam::{
        error_meta::Error as IamError, operation::DeleteRolePermissionsBoundaryInternalRequest,
...
impl RequestExecutor for DeleteRolePermissionsBoundaryInternalRequest {
    ...
    async fn execute(&self, tx: &mut PgTransaction<'_>, request_id: RequestId) -> Result<Self::Response, Self::Error> {
        delete_role_permissions_boundary(tx, &self.account_id, &self.role_name, request_id).await
    }
}
