...
pub fn validate_tag_key(tag_key: impl AsRef<str>) -> Result<(), ValidationError> {
    validate_tag_key_inner(tag_key.as_ref())
}

fn validate_tag_key_inner(tag_key: &str) -> Result<(), ValidationError> {
...
pub fn validate_tag_value(tag_value: impl AsRef<str>) -> Result<(), ValidationError> {
    validate_tag_value_inner(tag_value.as_ref())
}

fn validate_tag_value_inner(tag_value: &str) -> Result<(), ValidationError> {
