...
/// The Scratchstack implementation of the AWS Identity and Access Management (IAM) Service.
///
...
impl ServiceDescriptor for IamService {
    const DEFAULT_PORT: u16 = 7401;
    const SERVICE: &'static str = SERVICE_IAM;
    const XML_NAMESPACE: &'static str = XML_NS_IAM;
