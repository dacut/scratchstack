...
impl SmithyModel {
    ...
    fn add_builtins(&mut self) {
        if !self.shapes.contains_key("smithy.api#Boolean") {
            let base = ShapeBase {
        ...
        if !self.shapes.contains_key("smithy.api#BigInteger") {
            let base = ShapeBase {
        ...
        if !self.shapes.contains_key("smithy.api#BigDecimal") {
            let base = ShapeBase {
        ...
        if !self.shapes.contains_key("smithy.api#Byte") {
            let base = ShapeBase {
        ...
        if !self.shapes.contains_key("smithy.api#Document") {
            let base = ShapeBase {
        ...
        if !self.shapes.contains_key("smithy.api#Float") {
            let base = ShapeBase {
        ...
        if !self.shapes.contains_key("smithy.api#Double") {
            let base = ShapeBase {
        ...
        if !self.shapes.contains_key("smithy.api#Integer") {
            let base = ShapeBase {
        ...
        if !self.shapes.contains_key("smithy.api#Long") {
            let base = ShapeBase {
        ...
        if !self.shapes.contains_key("smithy.api#Short") {
            let base = ShapeBase {
        ...
        if !self.shapes.contains_key("smithy.api#String") {
            let base = ShapeBase {
        ...
        if !self.shapes.contains_key("smithy.api#Timestamp") {
            let base = ShapeBase {
        ...
        if !self.shapes.contains_key("smithy.api#Unit") {
            let base = ShapeBase {
