...
use {
    ...
    scratchstack_shapes_iam::{
        ...
        operation::{
            ...
            GetUserInternalRequest, ListAccountsRequest, ListAttachedGroupPoliciesInternalRequest,
            ListAttachedRolePoliciesInternalRequest, ListAttachedUserPoliciesInternalRequest,
            ListGroupsForUserInternalRequest, ListGroupsInternalRequest, ListPoliciesInternalRequest,
            ListPolicyVersionsRequest, ListUserTagsInternalRequest, RemoveUserFromGroupInternalRequest,
            SetCurrentPartitionRequest, SetDefaultPolicyVersionRequest, TagPolicyRequest, TagUserInternalRequest,
            UntagPolicyRequest, UntagUserInternalRequest, UpdateGroupInternalRequest,
        },
...
async fn test_database() {
    ...
    test_attach_user_policy_simple(&pool).await;
    test_attach_user_policy_idempotent(&pool).await;
    test_attach_user_policy_nonexistent_policy(&pool).await;
    test_attach_user_policy_nonexistent_user(&pool).await;
    test_attach_group_policy_simple(&pool).await;
    test_attach_group_policy_idempotent(&pool).await;
    test_attach_group_policy_nonexistent_policy(&pool).await;
    test_attach_group_policy_nonexistent_group(&pool).await;
    test_attach_role_policy_simple(&pool).await;
    ...
    test_list_attached_user_policies_seed(&pool).await;
    test_list_attached_user_policies_empty(&pool).await;
    test_list_attached_user_policies_nonexistent_user(&pool).await;
    test_list_attached_user_policies_path_prefix(&pool).await;
    test_list_attached_user_policies_pagination(&pool).await;
    test_list_attached_group_policies_seed(&pool).await;
    test_list_attached_group_policies_nonexistent_group(&pool).await;
    test_list_attached_role_policies_seed(&pool).await;
    test_list_attached_role_policies_nonexistent_role(&pool).await;
    ...
    // -- DeletePolicyRequest --------------------------------------------------
    test_delete_policy_simple(&pool).await;
    test_delete_policy_cascade_tags_and_default_version(&pool).await;
    test_delete_policy_attached_to_user_fails(&pool).await;
    test_delete_policy_attached_to_group_fails(&pool).await;
    test_delete_policy_attached_to_role_fails(&pool).await;
    test_delete_policy_user_permissions_boundary_fails(&pool).await;
    test_delete_policy_role_permissions_boundary_fails(&pool).await;
    test_delete_policy_with_non_default_versions_fails(&pool).await;
    test_delete_policy_nonexistent(&pool).await;
    test_delete_policy_mismatched_path(&pool).await;
    test_delete_policy_invalid_arn(&pool).await;
    test_delete_policy_aws_account(&pool).await;
...
async fn test_attach_user_policy_simple(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
...
async fn test_attach_user_policy_idempotent(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
...
async fn test_attach_user_policy_nonexistent_policy(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
...
async fn test_attach_user_policy_nonexistent_user(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
    let result = AttachUserPolicyInternalRequest::builder()
        .account_id("123456789012".to_string())
...
async fn test_attach_group_policy_simple(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
...
async fn test_attach_group_policy_idempotent(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
...
async fn test_attach_group_policy_nonexistent_policy(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
...
async fn test_attach_group_policy_nonexistent_group(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
    let result = AttachGroupPolicyInternalRequest::builder()
        .account_id("123456789012".to_string())
        .group_name("NonexistentGroup".to_string())
...
async fn test_attach_role_policy_simple(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
...
async fn test_attach_role_policy_idempotent(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
...
async fn test_attach_role_policy_nonexistent_policy(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
...
async fn test_attach_role_policy_nonexistent_role(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
    let result = AttachRolePolicyInternalRequest::builder()
        .account_id("123456789012".to_string())
...
async fn test_list_attached_user_policies_seed(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
...
async fn test_list_attached_user_policies_empty(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
    let resp = ListAttachedUserPoliciesInternalRequest::builder()
        .account_id("123456789012".to_string())
        .user_name("alice".to_string())
...
async fn test_list_attached_user_policies_nonexistent_user(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
...
async fn test_list_attached_user_policies_path_prefix(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
    let resp = ListAttachedUserPoliciesInternalRequest::builder()
        .account_id("210987654321".to_string())
        .user_name("Example-User-2".to_string())
...
async fn test_list_attached_user_policies_pagination(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
...
async fn test_list_attached_group_policies_seed(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
...
async fn test_list_attached_group_policies_nonexistent_group(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
...
async fn test_list_attached_role_policies_seed(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
...
async fn test_list_attached_role_policies_nonexistent_role(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
...
async fn test_delete_policy_simple(pool: &sqlx::PgPool) {
...
async fn test_delete_policy_cascade_tags_and_default_version(pool: &sqlx::PgPool) {
...
async fn test_delete_policy_attached_to_user_fails(pool: &sqlx::PgPool) {
...
async fn test_delete_policy_attached_to_group_fails(pool: &sqlx::PgPool) {
...
async fn test_delete_policy_attached_to_role_fails(pool: &sqlx::PgPool) {
...
async fn test_delete_policy_user_permissions_boundary_fails(pool: &sqlx::PgPool) {
...
async fn test_delete_policy_role_permissions_boundary_fails(pool: &sqlx::PgPool) {
...
async fn test_delete_policy_with_non_default_versions_fails(pool: &sqlx::PgPool) {
...
async fn test_delete_policy_nonexistent(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
    let err = DeletePolicyRequest::builder()
...
async fn test_delete_policy_mismatched_path(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
    CreatePolicyInternalRequest::builder()
...
/// Deleting with an unparseable ARN must fail with ValidationError.
async fn test_delete_policy_invalid_arn(pool: &sqlx::PgPool) {
    let cases: &[(&str, &str)] = &[
        ("not-an-arn-but-long-enough-to-pass", "unparseable ARN"),
        ("arn:test-partition:s3:::policy/SomePolicy", "wrong service"),
        ("arn:test-partition:iam:us-east-1:123456789012:policy/SomePolicy", "non-empty region"),
...
/// ARN.
async fn test_delete_policy_aws_account(pool: &sqlx::PgPool) {
    let mut tx = pool.begin().await.expect("Failed to begin transaction");
    CreatePolicyInternalRequest::builder()
