...
compiled in at all without it. The `sensitive_log` family of macros comes from `scratchstack-core`,
but the gate is this crate's own feature: enabling it here does not switch on any other crate's
sensitive records, and vice versa.
